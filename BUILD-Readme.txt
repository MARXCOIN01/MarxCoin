...
git clone https://github.com/cryptostar/MarxCoin.git
cd MarxCoin
chmod +x linuxMarxCoin.sh
./linuxMarxCoin.sh --build

Linux x86_64:

git clone https://github.com/cryptostar/MarxCoin.git
cd MarxCoin
chmod +x linuxMarxCoin64.sh
./linux64MarxCoin.sh --build

Options:
--reset: update dependencies, clone MarxCoin repository
--force: if you are using other versions such as Debian version > 7

Example with options:
./linux64MarxCoin.sh --reset --force --build

After successful build, marxcoind can be found in MarxCoin/src/
