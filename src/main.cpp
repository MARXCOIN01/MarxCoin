...
#if defined(NDEBUG)
# error "MarxCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "MarxCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    int64_t nSubsidy = 200000 * COIN;
        ...
        {
            nSubsidy = 200000 * COIN; // 1 billion coins for ico
        }
